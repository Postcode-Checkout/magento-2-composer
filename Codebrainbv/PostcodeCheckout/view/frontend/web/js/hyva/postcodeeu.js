...
function pcm2_hideForm(pcm2_Section, defaultForm = false) {
    ...
    if (defaultForm) {
        ...
        // Hide address fields
        var html =
            '<div class="field" id="pcm2_' + pcm2_Section + '_autocomplete_search_wrapper">' +
            '  <label class="label" for="pcm2_' + pcm2_Section + '_autocomplete_search"><span> ' + translate.pcm2_translations.search_address + ' </span></label>' +
            '  <div class="control"><input id="pcm2_' + pcm2_Section + '_autocomplete_search" name="pcm2_autocomplete_search" type="text" class="input-text" required /></div>' +
            '</div>' +
            '<div class="field" id="pcm2_' + pcm2_Section + '_autocomplete_result_wrapper">' +
            '</div>' +
            '<div class="field"><div class="control">' +
            '  <button type="button" class="action secondary" id="pcm2_' + pcm2_Section + '_autocomplete_manualbtn">' + translate.pcm2_translations.manual + '</button> ' +
            '  <button type="button" class="action secondary" id="pcm2_' + pcm2_Section + '_autocomplete_autobtn" style="display:none;">' + translate.pcm2_translations.automatic + '</button>' +
            '</div></div>';
...
function pcm2_getFields(pcm2_Section) {
    ...
    fields = {
        ...
        region: document.getElementById(pcm2_Section + '-region'),
    };
...
function pcm2_getElements(pcm2_Section) {
    ...
    elements = {
        ...
        postcode: document.getElementById(pcm2_Section + '-postcode').closest('div.field'),
        city: document.getElementById(pcm2_Section + '-city').closest('div.field'),
        region: document.getElementById(pcm2_Section + '-region').closest('div.field'),
        country: document.getElementById(pcm2_Section + '-country_id').closest('div.field'),
    };
